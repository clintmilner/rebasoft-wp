...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	<td style="text-align:right" width="200"><?php echo $hesklang['alo']; ?>: [<a href="Javascript:void(0)" onClick="Javascript:hesk_window('../help_files/settings.html#14','400','500')"><b>?</b></a>]</td>
	<td>
	<?php
