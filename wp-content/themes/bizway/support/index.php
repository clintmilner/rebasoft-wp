...
<tr>
	...
	<li><?php echo $hesklang['all_error_free']; ?>.</li>
   	<li>You have supplied a valid support PIN - we will not accept new support requests unless a valid PIN is supplied.</li>
    </ul>
...
<td>
<br />
<span class="purple"><h1>Rebasoft Support</h1></span>
<p>Standard support is provided 9-5:30 UTC</p>
<p>Customers are advised to check the <a href="knowledgebase.php">Knowledgebase</a>, as this documents most of the issues encountered by administrators setting up and using Rebasoft products</p>
<p>If you believe you have a new issue, or have a feature request, please submit a ticket, which will be forwarded to our support/development team</p> 
