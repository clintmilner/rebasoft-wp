...
function hesk_kb_header($kb_link) {
	...
	&gt; <?php echo $kb_link; ?></span>*/ ?> <span class="purple"><h1>Knowledgebase</h1></span>
	</td>
	<?php
	if ($hesk_settings['kb_search'])
	{
	    ...
	    <div style="display:inline;">
			...
			<input type="submit" value="'.$hesklang['search'].'"  />
			</form>
		</div>
		</td>
	    ';
...
function hesk_show_kb_article($artid) {
    ...
    <p style="font-size: 0.8em;">&nbsp;<br />&laquo; <a href="javascript:history.go(<?php echo isset($_GET['rated']) ? '-2' : '-1'; ?>)"><?php echo $hesklang['back']; ?></a></p>
...
function hesk_show_kb_category($catid, $is_search = 0) {
	...
	if ($thiscat['parent'])
	{
        ...
        &nbsp;(&laquo; <a style="font-size:0.9em;" href="javascript:history.go(-1)">'.$hesklang['back'].'</a>)
		';
	}
